...
import com.web.mapper.GonggaoMapper;
...
@Service
public class GonggaoServiceImpl extends ServiceImpl<GonggaoMapper, Gonggao> implements IGonggaoService {
    ...
    public PageUtils getPage(Map<String, Object> condition) {
        ...
        //新建分页对象
        Page<Gonggao> page = new Page<>(currPage, pageSize);
        //新建查询对象
        QueryWrapper<Gonggao> qw = new QueryWrapper<>();
        //查询条件
        qw.lambda().like(MapUtils.isNotBlank(condition, "gtitle"), Gonggao::getGtitle, condition.get("gtitle"));
